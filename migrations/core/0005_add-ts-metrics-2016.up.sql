...
create table ts_metrics_aggr_15m_m1_2016
    (check (created >= TIMESTAMPTZ '2016-01-01 00:00:00-00' and created <= date '2016-01-31' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);

create table ts_metrics_aggr_15m_m2_2016
    (check (created >= TIMESTAMPTZ '2016-02-01 00:00:00-00' and created <= date '2016-02-29' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);

create table ts_metrics_aggr_15m_m3_2016
    (check (created >= TIMESTAMPTZ '2016-03-01 00:00:00-00' and created <= date '2016-03-31' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);

create table ts_metrics_aggr_15m_m4_2016
    (check (created >= TIMESTAMPTZ '2016-04-01 00:00:00-00' and created <= date '2016-04-30' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);

create table ts_metrics_aggr_15m_m5_2016
    (check (created >= TIMESTAMPTZ '2016-05-01 00:00:00-00' and created <= date '2016-05-31' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);

create table ts_metrics_aggr_15m_m6_2016
    (check (created >= TIMESTAMPTZ '2016-06-01 00:00:00-00' and created <= date '2016-06-30' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);

create table ts_metrics_aggr_15m_m7_2016
    (check (created >= TIMESTAMPTZ '2016-07-01 00:00:00-00' and created <= date '2016-07-31' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);

create table ts_metrics_aggr_15m_m8_2016
    (check (created >= TIMESTAMPTZ '2016-08-01 00:00:00-00' and created <= date '2016-08-31' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);

create table ts_metrics_aggr_15m_m9_2016
    (check (created >= TIMESTAMPTZ '2016-09-01 00:00:00-00' and created <= date '2016-09-30' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);

create table ts_metrics_aggr_15m_m10_2016
    (check (created >= TIMESTAMPTZ '2016-10-01 00:00:00-00' and created <= date '2016-10-31' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);

create table ts_metrics_aggr_15m_m11_2016
    (check (created >= TIMESTAMPTZ '2016-11-01 00:00:00-00' and created <= date '2016-11-30' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);

create table ts_metrics_aggr_15m_m12_2016
    (check (created >= TIMESTAMPTZ '2016-12-01 00:00:00-00' and created <= date '2016-12-31' at time zone 'utc'))
    inherits (ts_metrics_aggr_15m);
...
begin
    if ( new.created >= TIMESTAMPTZ '2016-01-01 00:00:00-00' and new.created <= date '2016-01-31' at time zone 'utc') then
        insert into ts_metrics_aggr_15m_m1_2016 values (new.*);
    elsif ( new.created >= TIMESTAMPTZ '2016-02-01 00:00:00-00' and new.created <= date '2016-02-29' at time zone 'utc') then
        insert into ts_metrics_aggr_15m_m2_2016 values (new.*);
    elsif ( new.created >= TIMESTAMPTZ '2016-03-01 00:00:00-00' and new.created <= date '2016-03-31' at time zone 'utc') then
        insert into ts_metrics_aggr_15m_m3_2016 values (new.*);
    elsif ( new.created >= TIMESTAMPTZ '2016-04-01 00:00:00-00' and new.created <= date '2016-04-30' at time zone 'utc') then
        insert into ts_metrics_aggr_15m_m4_2016 values (new.*);
    elsif ( new.created >= TIMESTAMPTZ '2016-05-01 00:00:00-00' and new.created <= date '2016-05-31' at time zone 'utc') then
        insert into ts_metrics_aggr_15m_m5_2016 values (new.*);
    elsif ( new.created >= TIMESTAMPTZ '2016-06-01 00:00:00-00' and new.created <= date '2016-06-30' at time zone 'utc') then
        insert into ts_metrics_aggr_15m_m6_2016 values (new.*);
    elsif ( new.created >= TIMESTAMPTZ '2016-07-01 00:00:00-00' and new.created <= date '2016-07-31' at time zone 'utc') then
        insert into ts_metrics_aggr_15m_m7_2016 values (new.*);
    elsif ( new.created >= TIMESTAMPTZ '2016-08-01 00:00:00-00' and new.created <= date '2016-08-31' at time zone 'utc') then
        insert into ts_metrics_aggr_15m_m8_2016 values (new.*);
    elsif ( new.created >= TIMESTAMPTZ '2016-09-01 00:00:00-00' and new.created <= date '2016-09-30' at time zone 'utc') then
        insert into ts_metrics_aggr_15m_m9_2016 values (new.*);
    elsif ( new.created >= TIMESTAMPTZ '2016-10-01 00:00:00-00' and new.created <= date '2016-10-31' at time zone 'utc') then
        insert into ts_metrics_aggr_15m_m10_2016 values (new.*);
    elsif ( new.created >= TIMESTAMPTZ '2016-11-01 00:00:00-00' and new.created <= date '2016-11-30' at time zone 'utc') then
        insert into ts_metrics_aggr_15m_m11_2016 values (new.*);
    elsif ( new.created >= TIMESTAMPTZ '2016-12-01 00:00:00-00' and new.created <= date '2016-12-31' at time zone 'utc') then
