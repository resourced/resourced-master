...
create index ts_metrics_aggr_15m_m1_2016_simple_select on ts_metrics_aggr_15m_m1_2016 using brin (cluster_id, metric_id, created);
create index ts_metrics_aggr_15m_m2_2016_simple_select on ts_metrics_aggr_15m_m2_2016 using brin (cluster_id, metric_id, created);
create index ts_metrics_aggr_15m_m3_2016_simple_select on ts_metrics_aggr_15m_m3_2016 using brin (cluster_id, metric_id, created);
create index ts_metrics_aggr_15m_m4_2016_simple_select on ts_metrics_aggr_15m_m4_2016 using brin (cluster_id, metric_id, created);
create index ts_metrics_aggr_15m_m5_2016_simple_select on ts_metrics_aggr_15m_m5_2016 using brin (cluster_id, metric_id, created);
create index ts_metrics_aggr_15m_m6_2016_simple_select on ts_metrics_aggr_15m_m6_2016 using brin (cluster_id, metric_id, created);
create index ts_metrics_aggr_15m_m7_2016_simple_select on ts_metrics_aggr_15m_m7_2016 using brin (cluster_id, metric_id, created);
create index ts_metrics_aggr_15m_m8_2016_simple_select on ts_metrics_aggr_15m_m8_2016 using brin (cluster_id, metric_id, created);
create index ts_metrics_aggr_15m_m9_2016_simple_select on ts_metrics_aggr_15m_m9_2016 using brin (cluster_id, metric_id, created);
create index ts_metrics_aggr_15m_m10_2016_simple_select on ts_metrics_aggr_15m_m10_2016 using brin (cluster_id, metric_id, created);
create index ts_metrics_aggr_15m_m11_2016_simple_select on ts_metrics_aggr_15m_m11_2016 using brin (cluster_id, metric_id, created);
create index ts_metrics_aggr_15m_m12_2016_simple_select on ts_metrics_aggr_15m_m12_2016 using brin (cluster_id, metric_id, created);

create index ts_metrics_aggr_15m_m1_2016_aggregate_select on ts_metrics_aggr_15m_m1_2016 using brin (cluster_id, created, key);
create index ts_metrics_aggr_15m_m2_2016_aggregate_select on ts_metrics_aggr_15m_m2_2016 using brin (cluster_id, created, key);
create index ts_metrics_aggr_15m_m3_2016_aggregate_select on ts_metrics_aggr_15m_m3_2016 using brin (cluster_id, created, key);
create index ts_metrics_aggr_15m_m4_2016_aggregate_select on ts_metrics_aggr_15m_m4_2016 using brin (cluster_id, created, key);
create index ts_metrics_aggr_15m_m5_2016_aggregate_select on ts_metrics_aggr_15m_m5_2016 using brin (cluster_id, created, key);
create index ts_metrics_aggr_15m_m6_2016_aggregate_select on ts_metrics_aggr_15m_m6_2016 using brin (cluster_id, created, key);
create index ts_metrics_aggr_15m_m7_2016_aggregate_select on ts_metrics_aggr_15m_m7_2016 using brin (cluster_id, created, key);
create index ts_metrics_aggr_15m_m8_2016_aggregate_select on ts_metrics_aggr_15m_m8_2016 using brin (cluster_id, created, key);
create index ts_metrics_aggr_15m_m9_2016_aggregate_select on ts_metrics_aggr_15m_m9_2016 using brin (cluster_id, created, key);
create index ts_metrics_aggr_15m_m10_2016_aggregate_select on ts_metrics_aggr_15m_m10_2016 using brin (cluster_id, created, key);
create index ts_metrics_aggr_15m_m11_2016_aggregate_select on ts_metrics_aggr_15m_m11_2016 using brin (cluster_id, created, key);
create index ts_metrics_aggr_15m_m12_2016_aggregate_select on ts_metrics_aggr_15m_m12_2016 using brin (cluster_id, created, key);
